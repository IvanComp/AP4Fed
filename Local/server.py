...
from compute_models_ssim import main as compute_ssims
...
"""
    ...
    def aggregate_fit(
        ...
        if currentRnd > 0:
            ...
            for idx, ssim_val in enumerate(ssim_values, start=1):
                log(INFO, f"[CAM-SSIM] round {currentRnd} – client {idx}: SSIM={ssim_val:.4f}")
